    ...
    @endsection
    @section('content')
    <x-breadcrub pagetitle="LRTJ" subtitle="Devices Management" title="Device"  />
                            ...
                            @foreach($devices as $i => $devices)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Delete Form -->
                                        <button type="button" class="btn btn-sm btn-danger btn-delete" data-id="{{ $devices->id }}">

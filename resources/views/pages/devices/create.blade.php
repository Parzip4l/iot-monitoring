...
@section('content')
<x-breadcrub pagetitle="LRTJ" subtitle="Device Management" title="Add Device" />

<div class="container-fluid">
    <div class="page-content-wrapper">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create New Device</h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('device.store') }}" method="POST">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="serial_number" id="DeviceCode" 
                                    ...
                                    placeholder="Enter Device Code" value="{{ old('serial_number') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="type" class="form-control" id="">
                                    <option value="1">Humidity and Temperature</option>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="broker_ip" id="IpBroker" 
                                    ...
                                    placeholder="Enter IP Broker Device" value="{{ old('broker_ip') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="PortBroker" class="form-label fw-semibold">Port Broker</label>
                                <input type="text" name="broker_port" id="PortBroker" 
                                    class="form-control @error('broker_port') is-invalid @enderror"
                                    placeholder="Enter Port Broker Device" value="{{ old('broker_port') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="topic" id="DeviceCode" 
                                    ...
                                    placeholder="Enter Device Topic" value="{{ old('topic') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select name="car_id" id="carSelect" class="form-control">
                                    ...
                                    @foreach($cars as $c)
                                        <option value="{{ $c->id }}">{{ $c->car_number }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="carSelect" class="form-label fw-semibold">Interval Get Data (in second)</label>
                                <input type="number" name="interval" id="DeviceCode" 
                                    class="form-control @error('interval') is-invalid @enderror"
                                    placeholder="Enter Second to Get Data interval" value="{{ old('interval') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div> 
        ...
        if(trainId) {
            fetch(`/settings/train-config/train/${trainId}/cars`)
                ...
                .then(data => {
                    ...
                    data.forEach(car => {
                        options += `<option value="${car.id}">${car.car_number}</option>`;
                    });

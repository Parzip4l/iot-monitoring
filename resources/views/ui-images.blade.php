...
<x-breadcrub pagetitle="Morvin" subtitle="UI Elements" title="Images"  />
        ...
        <div class="page-content-wrapper">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Image Thumbnails</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Image Rounded & Circle</h4>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-2">
                                        <img class="rounded" alt="200x200" style="width: 200px;"
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Responsive Images</h4>
                            <p class="card-title-desc">Images in Bootstrap are made responsive
                                with <code>.img-fluid</code>. <code>max-width: 100%;</code> and <code>height: auto;</code>
                                are applied to
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Images Sizes</h4>

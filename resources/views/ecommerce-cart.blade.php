...
@endsection
@section('content')
    <x-breadcrub pagetitle="Morvin" subtitle="Ecommerce" title="Cart"  />
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered mb-0 table-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('build/images/product/img-7.png') }}" alt="product-img"
                                                    title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                                        href="ecommerce-product-detail" class="text-reset">Home &
                                                        Office Chair</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('build/images/product/img-8.png') }}" alt="product-img"
                                                    title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('build/images/product/img-9.png') }}" alt="product-img"
                                                    title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ URL::asset('build/images/product/img-11.png') }}" alt="product-img"
                                                    title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a

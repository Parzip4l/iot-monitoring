<head>
    <meta charset="utf-8" />
    <title> Preloader Layout | Morvin - Admin & Dashboard Template</title>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <x-breadcrub pagetitle="Morvin" subtitle="Layouts" title="Preloader Layout" />
                                                ...
                                                <a href="#">
                                                    <div class="media">
                                                        <div class="me-3 align-self-center">
                                                            <div
                                                                class="avatar-sm rounded bg-primary align-self-center">
                                                        ...
                                                        <p class="ms-2 pt-3">
                                                            <i
                                                                class="mdi mdi-arrow-top-right text-success me-1"></i>50%
                                                        </p>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="inbox-list-item">
                                                <a href="#">
                                                    <div class="media">
                                                        ...
                                                        <p class="ms-2 pt-3">
                                                            <i
                                                                class="mdi mdi-arrow-top-right text-success me-1"></i>45%
                                                        </p>
                                                    </div>
                                                </a>
                                            </li>
                                            ...
                                            <li class="inbox-list-item">
                                                <a href="#">
                                                    <div class="media">
                                                        ...
                                                        <p class="ms-2 pt-3">
                                                            <i
                                                                class="mdi mdi-arrow-top-right text-success me-1"></i>35%
                                                        </p>
                                                    </div>
                                                </a>
                                            </li>
                                            ...
                                            <li class="inbox-list-item">
                                                <a href="#" class="pb-0">
                                                    <div class="media">
                                                        ...
                                                        <p class="ms-2 pt-3">
                                                            <i
                                                                class="mdi mdi-arrow-top-right text-success me-1"></i>40%
                                                        </p>
                                                    </div>
                                                </a>
                                            </li>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ URL::asset('build/images/product/img-8.png') }}"
                                                                width="42" class="me-3" alt="">Office
                                                            Chair</td>
                                                        <td>Alfred Gordon</td>
                                                        <td>$242.00</td>
                                                        <td>54</td>

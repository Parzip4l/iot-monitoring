...
@endsection
@section('content')
    <x-breadcrub pagetitle="Morvin" subtitle="UI Elements" title="General"  />
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <p class="card-title-desc">Add any of the below mentioned modifier classes to change
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <button type="button" class="btn btn-secondary waves-effect" data-bs-container="body"
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">If you don’t fancy a border spinner, switch to the grow spinner.

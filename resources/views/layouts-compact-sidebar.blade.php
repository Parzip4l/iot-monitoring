<head>
    <meta charset="utf-8" />
    <title> Compact Sidebar | Morvin - Admin & Dashboard Template</title>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <x-breadcrub pagetitle="Morvin" subtitle="Layouts" title="Compact Sidebar"  />
                                        ...
                                        <ul class="list-unstyled activity-wid mb-0">
                                            ...
                                            <li class="activity-list activity-border">
                                                <div class="activity-icon avatar-sm">
                                                  ...
                                                  <img src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" class="avatar-sm rounded-circle" alt="">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>#2356</td>
                                                        <td><img src="{{ URL::asset('build/images/product/img-7.png') }}" width="42" class="me-3" alt="">Green Chair</td>
                                                    ...
                                                    <tr>
                                                        <td>#2564</td>
                                                        <td><img src="{{ URL::asset('build/images/product/img-8.png') }}" width="42" class="me-3" alt="">Office Chair</td>
                                                        <td>Alfred Gordon</td>
                                                        <td>$242.00</td>
                                                        <td>54</td>
                                                        <td><span
                                                    ...
                                                    <tr>
                                                        <td>#2125</td>
                                                        <td><img src="{{ URL::asset('build/images/product/img-10.png') }}" width="42" class="me-3" alt="">Gray Chair</td>
                                                        <td>Keena Reyes</td>
                                                        <td>$320.00</td>
                                                        <td>65</td>
                                                        <td><span
                                                    ...
                                                    <tr>
                                                        <td>#8587</td>
                                                        <td><img src="{{ URL::asset('build/images/product/img-11.png') }}" width="42" class="me-3" alt="">Steel Chair</td>
                                                    ...
                                                    <tr>
                                                        <td>#2354</td>
                                                        <td><img src="{{ URL::asset('build/images/product/img-12.png') }}" width="42" class="me-3" alt="">Home Chair</td>
                                                        <td>Joann Wiliams</td>
                                                        <td>$320.00</td>
                                                        <td>25</td>
                                                        <td><span

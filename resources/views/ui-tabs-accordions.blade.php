...
<x-breadcrub pagetitle="Morvin" subtitle="UI Elements" title="Tabs Accordions"  />
                                ...
                                <div class="col-md-9">
                                    <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                            ...
                                            <p>Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu
                                                banh mi,
                                        ...
                                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                            ...
                                            <p class="mb-0"> Qui photo booth letterpress, commodo enim craft beer mlkshk
                                                ...
                                                assumenda labore aesthetic magna 8-bit</p>
                                        </div>
                            ...
                            <div class="accordion" id="accordion_Example">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse_One" class="accordion-collapse collapse show"
                                        aria-labelledby="heading_One" data-bs-parent="#accordion_Example">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse_Two" class="accordion-collapse collapse"
                                        aria-labelledby="heading_Two" data-bs-parent="#accordion_Example">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse_Three" class="accordion-collapse collapse"
                                        aria-labelledby="heading_Three" data-bs-parent="#accordion_Example">
                                        <div class="accordion-body">

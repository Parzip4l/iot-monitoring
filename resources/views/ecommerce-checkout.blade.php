...
@section('content')
    ...
    <x-breadcrub pagetitle="Morvin" subtitle="Ecommerce" title="Checkout"  />
                            ...
                            <div id="checkout-nav-pills-wizard" class="twitter-bs-wizard">
                                ...
                                <div class="tab-content twitter-bs-wizard-tab-content">
                                    <div class="tab-pane" id="billing-info">
                                        ...
                                        <p class="card-title-desc">If several languages coalesce, the grammar of the
                                            resulting</p>
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                        <li class="next"><a href="#">Shipping Info <i
                                    ...
                                    <div class="tab-pane" id="shipping-info">
                                        ...
                                        <table class="table table-centered mb-0 table-nowrap">
                                            <thead>
                                                <tr>
                                                    <th class="border-top-0" style="width: 100px;" scope="col">Photo
                                                    </th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="{{ URL::asset('build/images/product/img-7.png') }}" alt="product-img"
                                                            title="product-img" class="avatar-md"></td>
                                                    <td>
                                                        <h5 class="font-size-16 text-truncate"><a
                                                                href="ecommerce-product-detail"
                                                                class="text-reset">Home & Office Chair Green</a></h5>
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="previous"><a href="#"><i
                                                        class="mdi mdi-arrow-left me-1"></i> Billing Info</a></li>
                                            <li class="next"><a href="#">Payment Info <i
                                                        class="mdi mdi-arrow-right ms-1"></i></a></li>
                                        </ul>
                                    ...
                                    <div class="tab-pane" id="payment-info">
                                        ...
                                        <div>
                                            ...
                                            <ul class="nav nav-pills nav-justified mb-3 mt-3" id="pills-tab"
                                                role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                                        ...
                                                        <div class="p-1">
                                                            <i
                                                                class="fab fa-cc-mastercard font-size-24 align-middle me-2"></i>
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                                    ...
                                                    <div class="p-4 border">
                                                        <form>
                                                            <div class="mb-4">
                                                                <label class="form-label" for="cardnameInput">Name on
                                                                    card</label>
                                                                <input type="text" class="form-control"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-sm-6">
                                                                    <div class="mb-4 mb-lg-0">
                                                                        <label class="form-label"
                                                                            for="cardnumberInput">Card Number</label>
                                                                        <input type="text" class="form-control"
                                                                            id="cardnumberInput"
                                                                ...
                                                                <div class="col-lg-4 col-sm-6">
                                                                    <div class="mb-4 mb-lg-0">
                                                                        <label class="form-label"
                                                                            for="expirydateInput">Expiry date</label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-lg-4 col-sm-6">
                                                                    <div class="mb-4 mb-lg-0">
                                                                        <label class="form-label" for="cvvcodeInput">CVV
                                                                            Code</label>
                                                                        <input type="text" class="form-control"
                                                                            id="cvvcodeInput"
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="previous"><a href="#"><i
                                                        class="mdi mdi-arrow-left me-1"></i> Shipping Info</a></li>
                                            <li class="float-end"><a href="#"> Complete order <i
                                                        class="mdi mdi-arrow-right ms-1"></i></a></li>
                                        </ul>
                        ...
                        <div class="card-body">
                            <table class="table table-centered mb-0 table-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('build/images/product/img-8.png') }}" alt="product-img"
                                                title="product-img" class="avatar-md"></td>
                                        <td>
                                            <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail"
                                                    class="text-reset">Home & Office Chair Cream</a></h5>
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('build/images/product/img-10.png') }}" alt="product-img"
                                                title="product-img" class="avatar-md"></td>
                                        <td>
                                            <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail"
                                                    class="text-reset">Home & Office Chair Cream</a></h5>
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('build/images/product/img-6.png') }}" alt="product-img"
                                                title="product-img" class="avatar-md"></td>
                                        <td>
                                            <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail"
                                                    class="text-reset">Home & Office Chair Black</a></h5>

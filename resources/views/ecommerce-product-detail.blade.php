...
@endsection
@section('content')
    <x-breadcrub pagetitle="Morvin" subtitle="Ecommerce" title="Product Details"  />
                                                    ...
                                                    <div class="tab-pane fade show active" id="product-1" role="tabpanel">
                                                        <div class="product-img">
                                                            <img src="{{ URL::asset('build/images/product/img-7.png') }}" alt=""
                                                                ...
                                                                data-zoom="{{ URL::asset('build/images/product/img-1.png') }}">
                                                        </div>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-3">
                                    <div class="product-track rounded p-4">
                                        ...
                                        <p class="text-muted mt-3 mb-0">Passages and more recently with desktop publishing
                                            software like
                                ...
                                <div class="col-xl-3">
                                    <div class="product-track rounded p-4">
                                        ...
                                        <p class="text-muted mt-3 mb-0">Principle of selection: he rejects pleasures to
                                            secure other
                                ...
                                <div class="col-xl-3">
                                    <div class="product-track rounded p-4">
                                        ...
                                        <h5 class="text-uppercase mt-3 font-size-17">Online Support 24/7</h5>

                                        <p class="text-muted mt-3 mb-0">Itaque earum rerum hic tenetur a sapiente delectus
                                            ut aut reiciendis
                                ...
                                <div class="col-xl-3">
                                    <div class="product-track rounded p-4">
                                        ...
                                        <p class="text-muted mt-3 mb-0">Welcomed and every pain avoided certain
                            ...
                            <div class="border p-4 rounded">
                                <div class="media border-bottom pb-3">
                                    <div class="media-body">
                                        <p class="text-muted mb-2">To an English person, it will seem like simplified
                                            English, as a skeptical Cambridge</p>
                                        <h5 class="font-size-15 mb-3">James</h5>

                                        <ul class="list-inline product-review-link mb-0">
                                            <li class="list-inline-item">
                                                <a href="#"><i class="mdi mdi-thumb-up align-middle me-1"></i>
                                                    Like</a>
                                            </li>
                                            <li class="list-inline-item">
                                ...
                                <div class="media pt-3">
                                    <div class="media-body">
                                        <p class="text-muted mb-2">If several languages coalesce, the grammar of the
                                            resulting </p>

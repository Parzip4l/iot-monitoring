...
@endsection
@section('content')
    <x-breadcrub pagetitle="Morvin" subtitle="Forms" title="Form Wizard"  />
                                ...
                                <div class="tab-content twitter-bs-wizard-tab-content">
                                    <div class="tab-pane" id="seller-details">
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="next"><a href="#">Company Doct <i
                                        ...
                                        <div>
                                            <form>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="basicpill-pancard-input">PAN
                                                                Card</label>
                                                            <input type="text" class="form-control"
                                                                id="basicpill-pancard-input" placeholder="Enter Pan Card">
                                                        </div>
                                                    </div>
                                                    <!-- end col -->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="basicpill-vatno-input">VAT/TIN
                                                                No.</label>
                                                            <input type="text" class="form-control"
                                                                id="basicpill-vatno-input" placeholder="Enter VAT/TIN No.">
                                                        </div>
                                                    </div>
                                                    <!-- end col -->
                                                </div><!-- end row -->
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="basicpill-servicetax-input">Service Tax No.</label>
                                                            <input type="text" class="form-control"
                                            ...
                                            <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                <li class="previous"><a href="#"><i
                                                            class="mdi mdi-arrow-left me-1"></i> Seller Details</a></li>
                                                <li class="next"><a href="#">Bank Details <i
                                                            class="mdi mdi-arrow-right ms-1"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="bank-detail">
                                        <div>
                                            ...
                                            <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                <li class="previous"><a href="#"><i
                                                            class="mdi mdi-arrow-left me-1"></i> Company Doct</a></li>
                                                <li class="next"><a href="#">Confirm Details <i
                                                            class="mdi mdi-arrow-right ms-1"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="confirm-detail">
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="previous"><a href="#"><i
                                                        class="mdi mdi-arrow-left me-1"></i> Bank Details</a></li>
                                            <li class="float-end"><a href="#">Confirm <i
                                                        class="mdi mdi-arrow-right ms-1"></i></a></li>
                                        </ul>
                                    </div>
                                    <!-- end tabpane -->
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="progress-basicpill-lastname-input">Last name</label>
                                                        <input type="text" class="form-control"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="progress-basicpill-cstno-input" placeholder="CST No.">
                                                        </div>
                                                    </div>
                                                    <!-- end col -->
                                                    <div class="col-lg-6">

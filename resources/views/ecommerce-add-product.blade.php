...
@section('content')
    <x-breadcrub pagetitle="Morvin" subtitle="Ecommerce" title="Add Product" />
                            ...
                            <div id="addproduct-nav-pills-wizard" class="twitter-bs-wizard">
                                ...
                                <div class="tab-content twitter-bs-wizard-tab-content">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="manufacturername" name="manufacturername" type="text"
                                                            class="form-control" placeholder="Enter manufacturer name">
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                                <div class="col-lg-4">
                                    ...
                                    <div class="tab-pane" id="product-img">
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="previous"><a href="#"><i
                                                        class="mdi mdi-arrow-left me-1"></i> Basic Info</a></li>
                                    ...
                                    <div class="tab-pane" id="metadata">
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="previous"><a href="#"><i
                                                        class="mdi mdi-arrow-left me-1"></i> Product Img</a></li>

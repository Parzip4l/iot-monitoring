...
<x-breadcrub pagetitle="Morvin" subtitle="UI Elements" title="UI Elements"  />
                ...
                <div class="col-xl-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h1 class="mb-3">h1. Bootstrap heading <small class="text-muted">Semibold 2.25rem
                                    (36px)</small></h1>
                            <h2 class="mb-3">h2. Bootstrap heading <small class="text-muted">Semibold 1.8rem
                                    (28.8px)</small></h2>
                            <h3 class="mb-3">h3. Bootstrap heading <small class="text-muted">Semibold 1.575rem
                                    (25.2px)</small></h3>
                            <h4 class="mb-3">h4. Bootstrap heading <small class="text-muted">Semibold 1.35rem
                                    (21.6px)</small></h4>
                            <h5 class="mb-3">h5. Bootstrap heading <small class="text-muted">Semibold 1.125rem
                                    (18px)</small></h5>
                            <h6 class="mb-0">h6. Bootstrap heading <small class="text-muted">Semibold 0.9rem
                                    (14.4px)</small></h6>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Unstyled List</h4>
                            <p class="card-title-desc">Remove the default <code>list-style</code> and left margin on list
                ...
                <div class="col-xl-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">For quoting blocks of content from
                                another source within your document. Wrap <code>&lt;blockquote
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Inline List</h4>
                            <p class="card-title-desc">Remove a list’s bullets and apply some
                                light <code>margin</code> with a combination
                                of two classes, <code>.list-inline</code> and

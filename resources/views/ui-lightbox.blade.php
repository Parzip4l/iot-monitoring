...
@section('content')
    ...
    <x-breadcrub pagetitle="Morvin" subtitle="UI Elements" title="Lightbox"  />
                                ...
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <a class="image-popup-vertical-fit" href="{{ URL::asset('build/images/small/img-2.jpg') }}"
                                            ...
                                            <img class="img-fluid" alt="" src="{{ URL::asset('build/images/small/img-2.jpg') }}"
                                                width="145">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mt-4 mt-sm-0">
                                        ...
                                        <a class="image-popup-no-margins" href="{{ URL::asset('build/images/small/img-3.jpg') }}">
                                            <img class="img-fluid" alt="" src="{{ URL::asset('build/images/small/img-3.jpg') }}"
                                                width="75">
                                        </a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="zoom-gallery">
                                <a class="float-start" href="{{ URL::asset('build/images/small/img-3.jpg') }}" title="Project 1"><img
                                        src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" width="275"></a>
                                <a class="float-start" href="{{ URL::asset('build/images/small/img-7.jpg') }}" title="Project 2"><img
                                        src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="" width="275"></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="button-items">
                                        <a class="popup-youtube btn btn-secondary"
                                            href="https://www.youtube.com/watch?v=0O2aH4XLbto">Open YouTube Video</a>
                                        <a class="popup-vimeo btn btn-secondary" href="https://vimeo.com/45830194">Open
                                            Vimeo Video</a>
                                        <a class="popup-gmaps btn btn-secondary"

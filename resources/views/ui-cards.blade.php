...
<x-breadcrub pagetitle="Morvin" subtitle="UI Elements" title="Cards"  />
    ...
    <div class="container-fluid">
        <div class="page-content-wrapper">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-body">
                        <h3 class="card-title font-size-16 mt-0">Special title treatment</h3>
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="Card image cap">
                    </div>
                </div>

                <div class="col-xl-4">
                    <div class="card">
                        <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="Card image">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card text-white" style="background-color: #333; border-color: #333;">
                        <div class="card-body">
                            <h3 class="card-title font-size-16 mt-0 text-white">Special title treatment</h3>
                            <p class="card-text">With supporting text below as a natural lead-in to
                                additional content.</p>
                    ...
                    <div class="card text-white bg-primary">
                        <div class="card-body">
                            <blockquote class="card-bodyquote mb-0">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                    erat a ante.</p>
                                <footer class="blockquote-footer mt-0 text-white">
                                    Someone famous in <cite title="Source Title">Source Title</cite>
                                </footer>
                            </blockquote>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="my-4 font-size-18">Cards Masonry</h4>
                    ...
                    <div class="row" data-masonry='{"percentPosition": true }'>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" class="card-img-top" alt="...">
                                <div class="card-body">

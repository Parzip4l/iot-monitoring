        ...
        <div class="d-flex">
            ...
            <div class="topbar-social-icon me-3 d-none d-md-block">
                <ul class="list-inline title-tooltip m-0">
                    ...
                    <li class="list-inline-item">
                        <a href="chat" data-bs-toggle="tooltip" data-placement="top" title="Chat">
                    ...
                    <li class="list-inline-item">
                        <a href="pages-invoice" data-bs-toggle="tooltip" data-placement="top" title="Printer">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-md-block ms-2">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="{{ URL::asset('build/images/flags/french.jpg') }}" alt="user-image" class="me-1"

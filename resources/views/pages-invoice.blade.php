...
@section('content')
    ...
    <x-breadcrub pagetitle="Morvin" subtitle="Pages" title="Invoice"  />
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="invoice-title">
                                        ...
                                        <h3 class="m-t-0">
                                            <img src="{{ URL::asset('build/images/logo-dark.png') }}" alt="logo" height="18" />
                                        </h3>
                                    </div>
                                    <hr>
                                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="panel panel-default">
                                        <div class="p-2">
                                            <h3 class="panel-title font-size-20"><strong>Order summary</strong></h3>
                                        </div>
                                        <div>
                                            ...
                                            <div class="d-print-none mo-mt-2">
                                                <div class="float-end">
                                                    ...
                                                    <a href="#"
                                                        class="btn btn-primary waves-effect waves-light ms-1">Send</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

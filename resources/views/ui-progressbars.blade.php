...
<x-breadcrub pagetitle="Morvin" subtitle="UI Elements" title="Progress Bars"  />
        ...
        <div class="page-content-wrapper">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Default Examples</h4>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Labels Example</h4>
                            <p class="card-title-desc">Add labels to your progress bars by placing text within the
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Custom Progress</h4>

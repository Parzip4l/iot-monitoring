                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <div class="text-center">
                                        <a href="index">
                                            <img src="{{ URL::asset('build/images/logo-dark.png') }}" height="22" alt="logo">
                                        </a>
                                    ...
                                    <form class="form-horizontal mt-4 pt-2" action="index">
                        ...
                        <div class="mt-5 text-center text-white">
                            <p>Don't have an account ?<a href="auth-register" class="fw-bold text-white"> Register</a>
                            </p>
                            <p>©
                                <script>
